...
public class BayesianScanner extends CommandSupport implements Function<BayesianScanner.Arguments, String> {

    public BayesianScanner() {
    }

    public BayesianScanner(CommandSupport parentStep) {
        super(parentStep);
    }
