...
public class WaitUntilPullRequestMerged extends CommandSupport implements Function<WaitUntilPullRequestMerged.Arguments, Boolean> {
    public WaitUntilPullRequestMerged() {
    }

    public WaitUntilPullRequestMerged(CommandSupport parentStep) {
        super(parentStep);
    }
