...
public class MavenRelease extends CommandSupport implements Function<MavenRelease.Arguments, String> {

    public MavenRelease() {
    }

    public MavenRelease(CommandSupport parentStep) {
        super(parentStep);
    }
    ...
    public String apply(Arguments args) {
        ...
        sh("git checkout -b " + getenv("JOB_NAME", "cd-release") + "-" + version);
