...
public class ContentRepository extends CommandSupport implements Function<ContentRepository.Arguments, String> {
    public ContentRepository() {
    }

    public ContentRepository(CommandSupport parentStep) {
        super(parentStep);
    }
